...
class Scaler {
 public:
    ...
    int init(AVCodecContext *codec_ctx, int src_width, int src_height, int dst_width,
             int dst_height, int flags) {
...
class Picture {
 ...
 public:
    ...
    int init(enum AVPixelFormat pix_fmt, int width, int height) {
        ...
        av_image_fill_arrays(frame->data, frame->linesize, data, pix_fmt, width, height,
                             align_frame_buffer);
...
struct StreamerConfig {
    ...
    StreamerConfig(int source_width, int source_height, int stream_width, int stream_height,
                   int stream_fps, int stream_bitrate, const std::string &stream_profile,
